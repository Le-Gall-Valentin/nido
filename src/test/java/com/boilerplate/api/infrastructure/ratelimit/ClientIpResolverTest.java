package com.boilerplate.api.infrastructure.ratelimit;
...
class ClientIpResolverTest {
    ...
    private ClientIpResolver resolver(String... trustedProxies) {
        BoilerplateProperties.RateLimitProperties rateLimit =
            new BoilerplateProperties.RateLimitProperties(List.of(trustedProxies));
        BoilerplateProperties props = new BoilerplateProperties(
