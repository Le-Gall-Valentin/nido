...
class UpdateSavingsGoalCommandTest {
    ...
    void rejects_a_color_outside_the_palette() {
        assertThatThrownBy(() -> new UpdateSavingsGoalCommand(GOAL_ID, SPACE_ID, "Vacances", new BigDecimal("2000.00"), null, "#123456", "🎯"))
            .isInstanceOf(FinanceException.InvalidSavingsGoalAppearance.class);
    }

    @Test
    void rejects_a_glyph_outside_the_palette() {
        assertThatThrownBy(() -> new UpdateSavingsGoalCommand(GOAL_ID, SPACE_ID, "Vacances", new BigDecimal("2000.00"), null, "#5c7a58", "🐙"))
            .isInstanceOf(FinanceException.InvalidSavingsGoalAppearance.class);
    }
}
