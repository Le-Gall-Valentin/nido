...
import com.boilerplate.api.authentication.infrastructure.security.JwtAuthenticationFilter;
...
public class SecurityConfig {
    ...
    private CorsConfigurationSource corsConfigurationSource(BoilerplateProperties properties) {
