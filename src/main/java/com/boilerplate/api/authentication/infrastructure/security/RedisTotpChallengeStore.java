...
import com.boilerplate.api.authentication.domain.port.out.TotpChallengeStorePort;
...
public class RedisTotpChallengeStore implements TotpChallengeStorePort {
    ...
    public RedisTotpChallengeStore(StringRedisTemplate redisTemplate, BoilerplateProperties properties) {
