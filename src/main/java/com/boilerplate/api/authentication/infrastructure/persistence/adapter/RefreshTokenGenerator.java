...
import com.boilerplate.api.authentication.domain.port.out.RefreshTokenIssuerPort;
import com.boilerplate.api.authentication.domain.port.out.RefreshTokenRepository;
import com.boilerplate.api.authentication.domain.port.out.TokenHashPort;
...
public class RefreshTokenGenerator implements RefreshTokenIssuerPort {
    ...
    public String generate(UserCredentials user, int expiryDays) {
