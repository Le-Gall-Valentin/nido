...
import com.boilerplate.api.shared.service.RoleHierarchy;
...
public record User(
    ...
    public void ensureRoleNotAlreadyAssigned(Role newRole) {
        if (this.role == newRole) {
            throw new IdentityException.RoleAlreadyAssigned();
        }
    }
