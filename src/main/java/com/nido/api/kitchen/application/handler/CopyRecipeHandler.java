...
@ApplicationService
public class CopyRecipeHandler implements CopyRecipeUseCase {

    private final RecipeRepository recipeRepository;
    private final ResolveMembershipUseCase resolveMembershipUseCase;

    public CopyRecipeHandler(RecipeRepository recipeRepository, ResolveMembershipUseCase resolveMembershipUseCase) {
    ...
    @Override
    @Transactional
    public Recipe copy(UUID recipeId, UUID destinationSpaceId, SpaceMembership caller) {
        ...
        return recipeRepository.create(new CreateRecipeCommand(
