...
import pageFr from '@/pages/tasks/locales/fr.json'
import pageEn from '@/pages/tasks/locales/en.json'
...
const DUPLICATED = ['column', 'recurring_series', 'priority'] as const

describe('tasks namespace duplication', () => {
