...
describe('getSpaceDetail', () => {
  it('GET /spaces/{id}', async () => {
    ...
    const result = await spaceApi.getSpaceDetail('s-1')
  ...
  it('throws SpaceNotAccessibleError on 404', async () => {
    ...
    await expect(spaceApi.getSpaceDetail('s-1')).rejects.toBeInstanceOf(SpaceNotAccessibleError)
  })

  it('throws NetworkError on no response', async () => {
    mock.get.mockRejectedValue(new Error('network'))
    await expect(spaceApi.getSpaceDetail('s-1')).rejects.toBeInstanceOf(NetworkError)
  })
...
describe('listMembers', () => {
  it('GET /spaces/{id}/members', async () => {
    ...
    await spaceApi.listMembers('s-1')
  ...
  it('throws InsufficientRoleError on 403', async () => {
    ...
    await expect(spaceApi.listMembers('s-1')).rejects.toBeInstanceOf(InsufficientRoleError)
  })
})
...
describe('listInvitations', () => {
  it('GET /spaces/{id}/invitations', async () => {
    mock.get.mockResolvedValue({ data: [] })
    await spaceApi.listInvitations('s-1')
    expect(mock.get).toHaveBeenCalledWith('/spaces/s-1/invitations')
  })

  it('throws RateLimitError on 429', async () => {
    mock.get.mockRejectedValue(axiosErr(429))
    await expect(spaceApi.listInvitations('s-1')).rejects.toBeInstanceOf(RateLimitError)
  })
})
...
describe('listReceivedInvitations', () => {
  it('GET /me/invitations', async () => {
    mock.get.mockResolvedValue({ data: [] })
    await spaceApi.listReceivedInvitations()
    expect(mock.get).toHaveBeenCalledWith('/me/invitations')
  })

  it('throws ServerError on 500', async () => {
    mock.get.mockRejectedValue(axiosErr(500))
    await expect(spaceApi.listReceivedInvitations()).rejects.toBeInstanceOf(ServerError)
  })
})
...
describe('createSpace', () => {
  it('POST /spaces with body', async () => {
    ...
    await spaceApi.createSpace({ name: 'Chez nous', description: 'x', accent: '#c17a5c', glyph: '🏡', timezone: 'Europe/Paris' })
...
describe('updateSpace', () => {
  it('PATCH /spaces/{id} sends only provided fields', async () => {
    ...
    await spaceApi.updateSpace('s-1', { name: 'New name' })
  ...
  it('omits absent fields entirely, including when clearing description with an empty string', async () => {
    mock.patch.mockResolvedValue({ status: 204 })
    await spaceApi.updateSpace('s-1', { name: 'New name', description: '' })
  ...
  it('sends the timezone when it is the only thing that changed', async () => {
    ...
    mock.patch.mockResolvedValue({ status: 204 })
    await spaceApi.updateSpace('s-1', { timezone: 'America/Toronto' })
  ...
  it('throws PersonalSpaceImmutableError on 422', async () => {
    ...
    await expect(spaceApi.updateSpace('s-1', { name: 'x' })).rejects.toBeInstanceOf(PersonalSpaceImmutableError)
  })
  ...
  it('throws InvalidAppearanceError on 422 InvalidAppearance', async () => {
    ...
    await expect(spaceApi.updateSpace('s-1', { accent: '#000' })).rejects.toBeInstanceOf(InvalidAppearanceError)
  })

  it('throws InvalidSpaceNameError on 422 InvalidSpaceName', async () => {
    mock.patch.mockRejectedValue(axiosErr(422, 'InvalidSpaceName'))
    await expect(spaceApi.updateSpace('s-1', { name: 'x' })).rejects.toBeInstanceOf(InvalidSpaceNameError)
  })
  ...
  it('throws InvalidSpaceDescriptionError on 422 InvalidSpaceDescription', async () => {
    ...
    await expect(spaceApi.updateSpace('s-1', { description: 'x' })).rejects.toBeInstanceOf(InvalidSpaceDescriptionError)
  })
})
...
describe('deleteSpace', () => {
  it('DELETE /spaces/{id}', async () => {
    ...
    await spaceApi.deleteSpace('s-1')
...
describe('changeMemberRole', () => {
  it('PATCH /spaces/{id}/members/{userId} with role', async () => {
    mock.patch.mockResolvedValue({ status: 204 })
    await spaceApi.changeMemberRole('s-1', 'u-1', 'ADMIN')
  ...
  it('throws SpaceRoleAlreadyAssignedError on 409 RoleAlreadyAssigned', async () => {
    ...
    await expect(spaceApi.changeMemberRole('s-1', 'u-1', 'ADMIN')).rejects.toBeInstanceOf(SpaceRoleAlreadyAssignedError)
  })
  ...
  it('throws SelfManagementError on 409 SelfManagementForbidden', async () => {
    ...
    await expect(spaceApi.changeMemberRole('s-1', 'u-1', 'ADMIN')).rejects.toBeInstanceOf(SelfManagementError)
  })
  ...
  it('throws OwnerProtectedError on 409 OwnerMembershipProtected', async () => {
    ...
    await expect(spaceApi.changeMemberRole('s-1', 'u-1', 'ADMIN')).rejects.toBeInstanceOf(OwnerProtectedError)
  })

  it('throws ServerError on an unrecognized 409 title', async () => {
    mock.patch.mockRejectedValue(axiosErr(409, 'SomethingElse'))
    await expect(spaceApi.changeMemberRole('s-1', 'u-1', 'ADMIN')).rejects.toBeInstanceOf(ServerError)
  })
  ...
  it('throws OwnerRoleNotAssignableError on 422 OwnerRoleNotAssignable', async () => {
    ...
    await expect(spaceApi.changeMemberRole('s-1', 'u-1', 'ADMIN')).rejects.toBeInstanceOf(OwnerRoleNotAssignableError)
  })
})
...
describe('removeMember', () => {
  it('DELETE /spaces/{id}/members/{userId}', async () => {
    mock.delete.mockResolvedValue({ status: 204 })
    await spaceApi.removeMember('s-1', 'u-1')
  ...
  it('throws MemberNotFoundError on 404 MemberNotFound, distinct from a vanished space', async () => {
    ...
    await expect(spaceApi.removeMember('s-1', 'u-1')).rejects.toBeInstanceOf(MemberNotFoundError)
  })
})
...
describe('transferOwnership', () => {
  it('POST /spaces/{id}/members/{userId}/ownership', async () => {
    ...
    await spaceApi.transferOwnership('s-1', 'u-1')
...
describe('leaveSpace', () => {
  ...
  it('throws LastOwnerError on 409 LastOwnerCannotLeave', async () => {
    ...
    await expect(spaceApi.leaveSpace('s-1')).rejects.toBeInstanceOf(LastOwnerError)
  })
})
...
describe('inviteMember', () => {
  ...
  it('throws AlreadyMemberError on 409 AlreadyMember', async () => {
    ...
    await expect(spaceApi.inviteMember('s-1', 'carol@example.fr', 'MEMBER')).rejects.toBeInstanceOf(AlreadyMemberError)
  })
...
describe('revokeInvitation', () => {
  it('DELETE /spaces/{id}/invitations/{invitationId}', async () => {
    mock.delete.mockResolvedValue({ status: 204 })
    await spaceApi.revokeInvitation('s-1', 'i-1')
  ...
  it('throws InvitationNotFoundError on 404 InvitationNotFound', async () => {
    ...
    await expect(spaceApi.revokeInvitation('s-1', 'i-1')).rejects.toBeInstanceOf(InvitationNotFoundError)
  })
  ...
  it('throws InvitationNotPendingError on 409 InvitationNotPending', async () => {
    ...
    await expect(spaceApi.revokeInvitation('s-1', 'i-1')).rejects.toBeInstanceOf(InvitationNotPendingError)
  })
})
...
describe('acceptInvitation', () => {
  it('POST /invitations/{id}/accept and returns the joined spaceId', async () => {
    ...
    const result = await spaceApi.acceptInvitation('i-1')
  ...
  it('throws InvitationExpiredError on 422 InvitationExpired', async () => {
    ...
    await expect(spaceApi.acceptInvitation('i-1')).rejects.toBeInstanceOf(InvitationExpiredError)
  })

  it('throws InvitationNotFoundError on 404 InvitationNotFound', async () => {
    mock.post.mockRejectedValue(axiosErr(404, 'InvitationNotFound'))
    await expect(spaceApi.acceptInvitation('i-1')).rejects.toBeInstanceOf(InvitationNotFoundError)
  })
})
