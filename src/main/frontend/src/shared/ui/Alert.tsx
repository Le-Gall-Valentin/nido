...
const VARIANT_CLASS = {
  ...
  warning: 'bg-status-orange-dim text-status-orange',
...
export function Alert({ variant, children, onDismiss, dismissLabel, className = '' }: AlertProps) {
  ...
  return (
    <div
      ...
      className={`flex items-start gap-2.5 rounded-[10px] px-3.5 py-[11px] text-[13.5px] ${VARIANT_CLASS[variant]} ${className}`}
    >
